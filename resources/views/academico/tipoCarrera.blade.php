...
<div class="perfil-usuario-titulo">
    <h2>Rama Profesionales</h2>
</div>
<table id="tabla10">
</table>
<div class="perfil-usuario-titulo">
    <h2>Grupos Profesionales</h2>
</div>
<table id="tabla12">
</table>
<script>
    ...
    fetch('{{$urls["api"]}}').then(response =>{
        ...
        let elem=data.data.tipoCarrera
        ...
        let array=data.data.tipoRamaCarreras
        ...
        for(let i=0;i<array.length;i++){
            ...
            subnode01=document.createTextNode("VER GRUPO")
